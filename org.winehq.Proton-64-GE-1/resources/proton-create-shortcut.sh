...
shortcut" --entry)
    ...
    deskEntry="[Desktop Entry]"\\n"Exec=flatpak run org.winehq.Proton-64-GE-1 \""$myFile"\""\\n"Name=\
...
$category;"\\n"Icon="$myFile.icon.png""
    ...
    mkdir -p "$HOME/.local/share/applications/Proton-64-GE-1/"
    ln -s "$myFile.desktop" "$HOME/.local/share/applications/Proton-64-GE-1/$myBaseName.desktop"
