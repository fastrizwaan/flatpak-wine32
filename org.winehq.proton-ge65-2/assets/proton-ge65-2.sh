#!/bin/bash
export WINEPREFIX=~/.local/share/proton-ge65-2/default
...
mkdir -p ~/.local/share/applications/proton-ge65-2/
echo '
[Desktop Entry]
Exec=flatpak kill org.winehq.proton-ge65-2
Name=Proton-GE-6.5-2 kill (6.5)
Type=Application
Categories=Application;;
Icon=org.winehq.proton-ge65-2-kill
Keywords=flatpak; proton; wine; kill;
' > ~/.local/share/applications/proton-ge65-2/killall_proton-ge65-2.desktop
...
# For commandline
    ...
    echo "proton-ge65-2 - run wine applicatins/games"
	echo " "
	echo "flatpak run org.winehq.proton-ge65-2 <argument>"
	echo " "
	echo "Arguments can be:"
	echo "bash      : open proton-ge65-2 sandbox in shell"
