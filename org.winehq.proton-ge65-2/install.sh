...
#flatpak remove org.winehq.proton-ge65-2 -y 2>/dev/null

echo "Starting flatpak build  [x]"

# Build
flatpak-builder --force-clean build-dir org.winehq.proton-ge65-2.yml && \
flatpak remove org.winehq.proton-ge65-2 -y && echo "Removed old flatpak     [x]"


# Create flatpak
echo "Creating flatpak repo   [x]"
flatpak-builder --repo="repo" --force-clean build-dir/ org.winehq.proton-ge65-2.yml 

echo "Installing proton-ge65-2 [x]"
flatpak-builder --user --install --force-clean build-dir/ org.winehq.proton-ge65-2.yml 
echo "Creating flatpak bundle [x]"
flatpak --user remote-add --no-gpg-verify "org.winehq.proton-ge65-2" "repo" 2>/dev/null
#flatpak build-bundle "repo" "org.winehq.proton-ge65-2_$date.flatpak" org.winehq.proton-ge65-2 6.5-20210425 --runtime-repo="https://flathub.org/repo/flathub.flatpakrepo"
flatpak build-bundle "repo" "org.winehq.proton-ge65-2-6.5-20210425.flatpak" org.winehq.proton-ge65-2 6.5-20210425

echo "Installing proton-ge65-2 [x]"
# Install
flatpak --user install "org.winehq.proton-ge65-2-6.5-20210425.flatpak" -y
