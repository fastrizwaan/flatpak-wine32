#!/bin/bash
export WINEPREFIX=~/.Proton-65-GE-2
...
mkdir -p ~/.local/share/applications/Proton-65-GE-2/
echo '
[Desktop Entry]
Exec=flatpak kill org.winehq.Proton-65-GE-2 
Name=Killall Proton-65-GE-2 instances
Type=Application
Categories=Application;;
Icon=org.winehq.Proton-65-GE-2
Keywords=flatpak; wine; kill;
' > ~/.local/share/applications/Proton-65-GE-2/killall_proton.desktop
