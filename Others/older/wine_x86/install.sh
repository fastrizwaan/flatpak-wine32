...
flatpak remove io.github.wine_x86 -y 2>/dev/null


# Build
flatpak-builder --force-clean build-dir io.github.wine_x86.yml 

# Create flatpak
flatpak-builder --repo="repo" --force-clean build-dir/ io.github.wine_x86.yml 
flatpak --user remote-add --no-gpg-verify "io.github.wine_x86" "repo"
flatpak build-bundle "repo" "io.github.wine_x86.flatpak" io.github.wine_x86 stable --runtime-repo="https://flathub.org/repo/flathub.flatpakrepo"

# Install
flatpak --user install io.github.wine_x86.flatpak -y
