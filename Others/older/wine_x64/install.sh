...
flatpak remove io.github.wine_x64 -y 2>/dev/null

# Build
flatpak-builder --force-clean build-dir io.github.wine_x64.yml 

# Create flatpak
flatpak-builder --repo="repo" --force-clean build-dir/ io.github.wine_x64.yml 
flatpak --user remote-add --no-gpg-verify "io.github.wine_x64" "repo"
flatpak build-bundle "repo" "io.github.wine_x64.flatpak" io.github.wine_x64 stable --runtime-repo="https://flathub.org/repo/flathub.flatpakrepo"

# Install
flatpak --user install io.github.wine_x64.flatpak -y
