...
```
flatpak remote-ls flathub | grep nvidia ; #or
...
### GUI
Right-Click on any exe and choose "Open with flatpak-wine32"
...
Enjoy Windows x86 / 32 bit Games and Application on Linux Desktops.
