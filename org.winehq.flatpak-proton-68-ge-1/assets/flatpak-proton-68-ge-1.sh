...
# For commandline
    ...
    echo "flatpak-proton-68-ge-1 - run wine applicatins/games"
	echo " "
	echo "flatpak run org.winehq.flatpak-proton-68-ge-1 <argument>"
	echo " "
	echo "Arguments can be:"
	echo "bash      : open flatpak-proton-68-ge-1 sandbox in shell"
