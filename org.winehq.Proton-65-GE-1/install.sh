...
#flatpak remove org.winehq.Proton-65-GE-1 -y 2>/dev/null


# Build
flatpak-builder --force-clean build-dir org.winehq.Proton-65-GE-1.yml 

# Create flatpak
flatpak-builder --repo="repo" --force-clean build-dir/ org.winehq.Proton-65-GE-1.yml 
flatpak --user remote-add --no-gpg-verify "org.winehq.Proton-65-GE-1" "repo"
flatpak build-bundle "repo" "org.winehq.Proton-65-GE-1.flatpak" org.winehq.Proton-65-GE-1 stable --runtime-repo="https://flathub.org/repo/flathub.flatpakrepo"

# Install
flatpak --user install org.winehq.Proton-65-GE-1.flatpak -y
